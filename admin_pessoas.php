    ...
    <div>
        ...
        <main class="container" style="max-width: 1400px;">
            ...
            <div class="d-flex justify-content-end mb-3">
                <button class="btn btn-success me-2" type="button">Adicionar Pessoa</button>
                <button class="btn btn-warning me-2" type="button">Atualizar Pessoa</button>
                <button class="btn btn-danger" type="button">Remover Pessoa</button>
            </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>1</td>
                            <td>João Silva</td>
                            <td>Descrição de João Silva</td>
                            <td>Projeto Alpha, Projeto Beta</td>
                            <td>01/01/2024</td>
                            <td>
                                <button class="btn btn-sm btn-warning me-1" type="button">Editar</button>
                        ...
                        <tr>
                            ...
                            <td>Descrição de Maria Oliveira</td>
                            <td>Projeto Gamma, Projeto Delta</td>
                            <td>01/02/2024</td>
                            <td>
                                <button class="btn btn-sm btn-warning me-1" type="button">Editar</button>
                                <button class="btn btn-sm btn-danger" type="button">Excluir</button>
